...
function RouteMeta({ pieces = [] }) {
  ...
  useEffect(() => {
    ...
    const routeMeta = {
      '/': ['SabotPress', 'A publication built with SabotPress.'],
      ...
      '/submit': ['Submit', 'Submit work or information to this publication.'],
      '/support': ['Support', 'Ways to support this publication.'],
      '/security': ['Security', 'Security and source-protection guidance for this publication.'],
      '/press': ['Press', 'Press information and public-facing materials for this publication.'],
      '/publications': ['Publications', 'Read publications and print projects.'],
      '/updates': ['Updates', 'Latest publication updates.'],
